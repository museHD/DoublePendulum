...
The length of these pendulums and the angle they are released can be customized using the UI. The simulation uses the Runge-Kutta differential equation solver in order to provide relatively accurate results. 
